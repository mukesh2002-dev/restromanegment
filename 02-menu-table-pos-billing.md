# Step 02 — Menu, Tables, POS & Billing
...
## Critical
Every successful paid bill must have:
- immutable unique bill ID
- order ID
- payment status
- paid timestamp
- total amount

This bill ID becomes the anchor for QR reward eligibility.
