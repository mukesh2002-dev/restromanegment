...
## Dummy Data
Generate 500 inventory items and realistic transactions.

Keep inventory service separate so POS consumption can later be automated from recipes.
