...
async function main() {
  ...
  await prisma.campaign.upsert({
    ...
    create: {
      restaurantId: rest.id,
      name: "Visit 4 Times & Get 40% OFF on 5th Visit",
      slug: "loyalty-stamp-5",
      description: "1 Visit = 1 Stamp 🎟️, 4 Visits = 4 Stamps, 5th Visit = 40% OFF (Min ₹300, Max ₹200). Card valid 30 days (1 Month), QR 24h, 1 stamp/day.",
      isActive: true,
      minRating: 4,
