# Step 08 — WhatsApp Automation & Customer Engagement

## Integration-Ready Architecture
Create a provider abstraction so WhatsApp can be connected later.
...
Never send marketing messages without the required consent.

## Birthday Automation
Customer has birthday date/month.
Campaign checks eligible customers.
Generate personalized message.
If campaign requires it, generate unique coupon.
...
Use mock sender in development.
