# Step 04 — Customer CRM, QR Review & Feedback

## QR
Support table QR and bill/reward QR.

The QR landing page should allow the customer to:
1. Enter/verify bill information or use a secure server-generated token.
2. Give rating: 1–5 stars.
3. Write feedback/review.
4. Enter name.
5. Mobile number.
6. Email.
7. Birthday/month-day where appropriate.
...
## Rating Rules
Make campaign thresholds configurable.

Example:
- 1–3 stars: feedback only
- 4 stars: reward according to campaign
- 5 stars: reward according to campaign

Do not require a positive review to obtain ordinary customer service. Reward campaigns must be configurable and compliant with the review platform's policies.

## Anti-Abuse
- One claim per bill
- Server-side validation
- Claim timestamp
- Device/IP metadata where lawful and configured
- Duplicate detection
- Rate limiting
